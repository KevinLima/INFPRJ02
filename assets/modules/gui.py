...
class Button:
    ...
    def track_mouse(self):
        ...
        if (mouseX > self.position.x - self.width * 0.5 and mouseX < self.position.x + self.width * 0.5 and mouseY > self.position.y - self.height * 0.5 and mouseY < self.position.y + self.height * 0.5):
            self.hover = True
